...
public enum GlyphFormat : uint
{
    ...
    /// <summary>
    ///     The glyph image is a bitmap, and can be described as an <see cref="Internal.FTBitmap"/>. You generally need to
    ///     access the ‘bitmap’ field of the <see cref="Internal.FTGlyphSlot"/> structure to read it.
    /// </summary>
    ...
    ///     <see cref="Outline"/>; you generally want to access the ‘outline’ field of the <see cref="Internal.FTGlyphSlot"/>
